...
(function () {
  ...
  function buildHeader() {
      ...
      <nav id="main-nav">
        ...
        <div class="nav-item">
          ...
          <div class="nav-dropdown">
            ...
            <a href="${r}pages/promo.html">❄ AT／工商招募</a>
    ...
    <div id="mobile-menu">
      ...
      <a class="mob-link mob-sub" href="${r}pages/promo.html">❄ AT／工商招募</a>
      ...
      <div class="footer-inner">
        <div>
          ...
          <ul class="footer-links">
            <li><span style="color:var(--text-muted);font-size:12px;">${C.forumSlogan || '凜夜天堂'}</span></li>
        ...
        <div>
          ...
          <ul class="footer-links">
            ...
            <li><a href="${r}pages/promo.html">AT／工商招募</a></li>
          </ul>
        </div>
      </div>
